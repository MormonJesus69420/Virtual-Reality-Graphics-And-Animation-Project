...
template<typename T, int n, int m>
PFiniteDifferenceVolume<T, n, m>::PFiniteDifferenceVolume(Vector<int,3> dim, int order): PVolume<T, n>(dim[0], dim[1] , dim[2])
{
    _pSet = GMlib::DVectorN<GMlib::CFDCell<float,3>,3>();
...
template <typename T, int n, int m>
PFiniteDifferenceVolume<T, n, m>::PFiniteDifferenceVolume(DVectorN< CFDCell<T, n>, 3, T> c, int order) : PVolume<T, n>(c.getDim()[0],c.getDim()[1],c.getDim()[2])
{
    _pSet = c;
    _order = order;
    init();
...
template <typename T, int n, int m>
inline
void PFiniteDifferenceVolume<T, n, m>::setPointSet(DVectorN<CFDCell<T, n>, 3, T> c, int order)
{
...
template <typename T, int n, int m>
inline
void PFiniteDifferenceVolume<T, n, m>::eval(T u, T v, T w, int d1, int d2, int d3, bool lu, bool lv, bool lw)
{
    int i=0,j=0,k=0;
...
template <typename T, int n, int m>
inline
T PFiniteDifferenceVolume<T, n, m>::getEndPU()
{
...
template <typename T, int n, int m>
inline
T PFiniteDifferenceVolume<T, n, m>::getEndPV()
{
...
template <typename T, int n, int m>
inline
T PFiniteDifferenceVolume<T, n, m>::getEndPW()
{
...
template <typename T, int n, int m>
inline
T PFiniteDifferenceVolume<T, n, m>::getStartPU()
{
    //    T val = _pSet[0][0][0](0);
...
template <typename T, int n, int m>
inline
T PFiniteDifferenceVolume<T, n, m>::getStartPV()
{
    //    T val = _pSet[0][0][0](1);
...
template <typename T, int n, int m>
inline
T PFiniteDifferenceVolume<T, n, m>::getStartPW()
{
    //    T val = _pSet[0][0][0](2);
...
template <typename T, int n, int m>
inline
void PFiniteDifferenceVolume<T, n, m>::forwardDiffU(int i, int j, int k, int d1, int d2, int d3)
{
...
template <typename T, int n, int m>
inline
void PFiniteDifferenceVolume<T, n, m>::backwardDiffU(int i,int j,int k,int d1,int d2,int d3)
{
...
template <typename T, int n, int m>
inline
void PFiniteDifferenceVolume<T, n, m>::symetricDiffU(int i,int j,int k,int d1,int d2,int d3)
{
...
template <typename T, int n, int m>
inline
void PFiniteDifferenceVolume<T, n, m>::forwardDiffV(int i,int j,int k,int d1,int d2,int d3)
{
...
template <typename T, int n, int m>
inline
void PFiniteDifferenceVolume<T, n, m>::backwardDiffV(int i,int j,int k,int d1,int d2,int d3)
{
...
template <typename T, int n, int m>
inline
void PFiniteDifferenceVolume<T, n, m>::symetricDiffV(int i,int j,int k,int d1,int d2,int d3)
{
...
template <typename T, int n, int m>
inline
void PFiniteDifferenceVolume<T, n, m>::forwardDiffW(int i,int j,int k,int d1,int d2,int d3)
{
...
template <typename T, int n, int m>
inline
void PFiniteDifferenceVolume<T, n, m>::backwardDiffW(int i,int j,int k,int d1,int d2,int d3)
{
...
template <typename T, int n, int m>
inline
void PFiniteDifferenceVolume<T, n, m>::symetricDiffW(int i,int j,int k,int d1,int d2,int d3)
{
...
template <typename T, int n, int m>
inline
void PFiniteDifferenceVolume<T, n, m>::replot(int m1, int m2, int m3, int d1, int d2, int d3)
{
...
template <typename T, int n, int m>
inline
void PFiniteDifferenceVolume<T, n, m>::init()
{
...
//                                std::cout << "ijk" << i << j << k << std::endl;
                            ...
                            if(i==0 && d1>0) forwardDiffU(i,j,k,d1,d2,d3);
                            if(j==0 && d2>0) forwardDiffV(i,j,k,d1,d2,d3);
                            if(k==0 && d3>0) forwardDiffW(i,j,k,d1,d2,d3);
                            if(i==(_pSet.getDim()[0]-1) && d1>0)  backwardDiffU(i,j,k,d1,d2,d3);
                            if(j==(_pSet.getDim()[1]-1) && d2>0)  backwardDiffV(i,j,k,d1,d2,d3);
                            if(k==(_pSet.getDim()[2]-1) && d3>0)  backwardDiffW(i,j,k,d1,d2,d3);
                            if (i>0 && i<(_pSet.getDim()[0]-1) && d1>0) symetricDiffU(i,j,k,d1,d2,d3);
                            if (j>0 && j<(_pSet.getDim()[1]-1) && d2>0) symetricDiffV(i,j,k,d1,d2,d3);
                            if (k>0 && k<(_pSet.getDim()[2]-1) && d3>0) symetricDiffW(i,j,k,d1,d2,d3);

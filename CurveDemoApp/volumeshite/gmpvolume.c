...
template <typename T, int n>
inline T PVolume<T, n>::getParDeltaU()
{
  return _sc_u * (getEndPU() - getStartPU());
}

template <typename T, int n>
inline T PVolume<T, n>::getParDeltaV()
{
  return _sc_v * (getEndPV() - getStartPV());
}

template <typename T, int n>
inline T PVolume<T, n>::getParDeltaW()
{
  return _sc_w * (getEndPW() - getStartPW());
}

template <typename T, int n>
inline T PVolume<T, n>::getParStartU()
{
  return getStartPU() + _tr_u;
}

template <typename T, int n>
inline T PVolume<T, n>::getParStartV()
{
  return getStartPV() + _tr_v;
}

template <typename T, int n>
inline T PVolume<T, n>::getParStartW()
{
  return getStartPW() + _tr_w;
}

template <typename T, int n>
inline T PVolume<T, n>::getParEndU()
{
  return getParStartU() + getParDeltaU();
}

template <typename T, int n>
inline T PVolume<T, n>::getParEndV()
{
  return getParStartV() + getParDeltaV();
}

template <typename T, int n>
inline T PVolume<T, n>::getParEndW()
{
  return getParStartV() + getParDeltaW();
}

template <typename T, int n>
inline CFDCell<T, n>& PVolume<T, n>::getPosition(T u, T v, T w)
{
  _eval(u, v, w, 0, 0, 0);
  return _p[0][0][0];
}
...
template <typename T, int n>
inline CFDCell<T, n>& PVolume<T, n>::getDerU(T u, T v, T w)
{
  _eval(u, v, w, 1, 0, 0);
...
template <typename T, int n>
inline int PVolume<T, n>::getSamPU(int i) const
{
  return _no_sam_p_u(i);
}

template <typename T, int n>
inline CFDCell<T, n>& PVolume<T, n>::getDerUU(T u, T v, T w)
{
  _eval(u, v, w, 2, 0, 0);
...
template <typename T, int n>
inline int PVolume<T, n>::getSamPV(int i) const
{
  return _no_sam_p_v(i);
}

template <typename T, int n>
inline CFDCell<T, n>& PVolume<T, n>::getDerV(T u, T v, T w)
{
  _eval(u, v, w, 0, 1, 0);
...
template <typename T, int n>
inline int PVolume<T, n>::getSamPW(int i) const
{
  return _no_sam_p_w(i);
}

template <typename T, int n>
inline CFDCell<T, n>& PVolume<T, n>::getDerVV(T u, T v, T w)
{
  _eval(u, v, w, 0, 2, 0);
...
template <typename T, int n>
inline int PVolume<T, n>::getSamplesU() const
{
  return _no_sam_u;
}

template <typename T, int n>
inline CFDCell<T, n>& PVolume<T, n>::getDerW(T u, T v, T w)
{
  _eval(u, v, w, 0, 0, 1);
...
template <typename T, int n>
inline int PVolume<T, n>::getSamplesV() const
{
  return _no_sam_v;
}

template <typename T, int n>
inline CFDCell<T, n>& PVolume<T, n>::getDerWW(T u, T v, T w)
{
  _eval(u, v, w, 0, 0, 2);
...
template <typename T, int n>
inline int PVolume<T, n>::getSamplesW() const
{
  return _no_der_w;
}

template <typename T, int n>
inline bool PVolume<T, n>::isClosedU() const
{
  return false;
}

template <typename T, int n>
inline bool PVolume<T, n>::isClosedV() const
{
  return false;
}

template <typename T, int n>
inline bool PVolume<T, n>::isClosedW() const
{
  return false;
}

template <typename T, int n>
inline CFDCell<T, n>& PVolume<T, n>::getDerUV(T u, T v, T w)
{
  _eval(u, v, w, 2, 2, 0);
...
template <typename T, int n>
inline void PVolume<T, n>::setDomainU(T start, T end)
{
...
template <typename T, int n>
inline CFDCell<T, n>& PVolume<T, n>::getDerUW(T u, T v, T w)
{
  _eval(u, v, w, 2, 0, 2);
...
template <typename T, int n>
inline void PVolume<T, n>::setDomainUScale(T sc)
{
  _sc_u = sc;
}

template <typename T, int n>
inline CFDCell<T, n>& PVolume<T, n>::getDerVW(T u, T v, T w)
{
  _eval(u, v, w, 0, 2, 2);
...
template <typename T, int n>
inline void PVolume<T, n>::setDomainUTrans(T tr)
{
  _tr_u = tr;
}

template <typename T, int n>
inline void PVolume<T, n>::setDomainV(T start, T end)
{
...
template <typename T, int n>
inline void PVolume<T, n>::setDomainVScale(T sc)
{
  _sc_v = sc;
}

template <typename T, int n>
inline DVectorN<CFDCell<T, n>, 3, T>& PVolume<T, n>::evaluate(const Point<T, 3>& p, const Point<T, 3>& d)
{
  return evaluate(p(0), p(1), p(2), d(0), d(1), d(2));
}

template <typename T, int n>
inline void PVolume<T, n>::setDomainVTrans(T tr)
{
  _tr_v = tr;
}

template <typename T, int n>
inline void PVolume<T, n>::setDomainW(T start, T end)
{
...
template <typename T, int n>
inline void PVolume<T, n>::setDomainWScale(T sc)
{
  _sc_w = sc;
}

template <typename T, int n>
inline DVectorN<CFDCell<T, n>, 3, T>& PVolume<T, n>::evaluate(T u, T v, T w, int d1, int d2, int d3)
{
...
template <typename T, int n>
inline void PVolume<T, n>::setDomainWTrans(T tr)
{
  _tr_w = tr;
}

template <typename T, int n>
inline void PVolume<T, n>::setNoDer(int d)
{
  _default_d = d;
}

template <typename T, int n>
inline void PVolume<T, n>::setSurroundingSphere(const DVectorN<DVectorN<CFDCell<T, n>, 3, T>, 3>& p)
{
...
template <typename T, int n>
inline void PVolume<T, n>::enableDefaultVisualizer(bool enable)
{
  if (!enable) {
...
template <typename T, int n>
inline const PVolumeVisualizer<T, n>* PVolume<T, n>::getDefaultVisualizer() const
{
  return _default_visualizer;
}

template <typename T, int n>
inline void PVolume<T, n>::toggleDefaultVisualizer()
{
...
template <typename T, int n>
inline void PVolume<T, n>::toggleSelectorGridVisualizer()
{
}

template <typename T, int n>
inline void PVolume<T, n>::insertVisualizer(Visualizer* visualizer)
{
  if (!visualizer)
    return;
...
template <typename T, int n>
inline void PVolume<T, n>::removeVisualizer(Visualizer* visualizer)
{
  SceneObject::removeVisualizer(visualizer);
}

template <typename T, int n>
inline void PVolume<T, n>::_eval(T u, T v, T w, int d1, int d2, int d3)
{
...
template <typename T, int n>
inline T PVolume<T, n>::shiftU(T u)
{
  return getStartPU() + _sc_u * (u - getParStartU());
}

template <typename T, int n>
inline T PVolume<T, n>::shiftV(T v)
{
  return getStartPV() + _sc_v * (v - getParStartV());
}

template <typename T, int n>
inline T PVolume<T, n>::shiftW(T w)
{
  return getStartPW() + _sc_w * (w - getParStartW());
}

template <typename T, int n>
inline const Point<T, n>& PVolume<T, n>::operator()(T u, T v, T w)
{
...
template <typename T, int n>
inline void PVolume<T, n>::preSample(
...
template <typename T, int n>
inline void PVolume<T, n>::resample(DVectorN<DVectorN<DVectorN<CFDCell<T, n>, 3, T>, 3, T>, 3, T>& p,
    int m1, int m2, int m3, int d1, int d2, int d3)
{
...
template <typename T, int n>
inline void PVolume<T, n>::findIndex(T u, T v, T w, int& i, int& j, int& k)
{
  //    T t = getParStartU();
  //    T t2 = getParDeltaU();
  //    T t3 = getParEndU();

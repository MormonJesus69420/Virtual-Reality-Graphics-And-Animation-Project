...
template<class T, int n>
GMlib::CFDCell<T,n>::CFDCell(T v):Vector<T,n>(v)
{
...
template<class T, int n>
inline
const GMlib::Vector< T, 4> GMlib::CFDCell<T, n>::getColor() const
{
  return _color;
}
...
template<class T, int n>
inline
void GMlib::CFDCell<T, n>::setColor(const GMlib::Vector<T, 4> color)
{
  _color = color;
}
...
template<class T, int n>
inline
void GMlib::CFDCell<T, n>::setColor(const T r, const T g, const T b, const T a)
{
...
template<class T, int n>
inline
void GMlib::CFDCell<T, n>::setPos(const GMlib::Vector<T, n> pos)
{
  _position = pos;
}
...
template<class T, int n>
inline
void GMlib::CFDCell<T,n>::setValue(const T val)
{
  _value = val;
}
...
template<class T, int n>
inline
void GMlib::CFDCell<T,n>::setDirection(const Vector<T, n> dir)
{
  _direction = dir;
}
...
template<class T, int n>
inline
const GMlib::Vector<T, 3> GMlib::CFDCell<T,n>::getPos() const
{
  return _position;
}
...
template<class T, int n>
inline
const T GMlib::CFDCell<T, n>::getValue() const
{
  return _value;
}
...
template<class T, int n>
inline
const GMlib::Vector<T, 3> GMlib::CFDCell<T, n>::getDirection() const
{
  return _direction;
}

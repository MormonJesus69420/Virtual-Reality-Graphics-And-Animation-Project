...
template <typename T, int n>
inline
void PVolumeDefaultVisualizer<T,n>::render(const GMlib::SceneObject* obj, const GMlib::DefaultRenderer* renderer) const{
...
template <typename T, int n>
inline
void PVolumeDefaultVisualizer<T,n>::renderGeometry(const GMlib::SceneObject *obj, const GMlib::Renderer *renderer, const GMlib::Color &color) const{
...
template <typename T, int n>
inline
void PVolumeDefaultVisualizer<T,n>::draw() const{
...
template <typename T, int n>
inline
void  PVolumeDefaultVisualizer<T,n>::replot( const DVectorN < DVectorN< CFDCell<T,n>, 3, T>, 3, T >& p,
...
template <typename T, int n>
inline
void PVolumeDefaultVisualizer<T, n>::setTransferValues(const std::vector<Vector<float, 4> >& rgba, bool update)
{
...
template <typename T, int n>
inline
void PVolumeDefaultVisualizer<T, n>::setTestTexture(unsigned char* volume_)
{
    //#3D Texture
    unsigned int h = 256;
    unsigned int w = 256;
...
template <typename T, int n>
inline
void PVolumeDefaultVisualizer<T,n>::setVolumeDisplayMode(VolumeDisplayMode mode)
{
    _display_mode = mode;
}
...
template <typename T, int n>
inline
void PVolumeDefaultVisualizer<T,n>::setShaders(bool colorMip, bool alphaMip, bool blackWhite, bool depthTerminate, bool depthStart, bool slicing)
{
    _colorMip = colorMip;
    _alphaMip = alphaMip;
...
template <typename T, int n>
inline
void PVolumeDefaultVisualizer<T,n>::setSlicingVector(Vector<float, 3> slicingVector)
{
...
template <typename T, int n>
inline
void PVolumeDefaultVisualizer<T,n>::setSlicingVector(float x, float y, float z)
{
...
template <typename T, int n>
inline
void PVolumeDefaultVisualizer<T,n>::setTransferType(int index)
{
    _transferType = index;
}

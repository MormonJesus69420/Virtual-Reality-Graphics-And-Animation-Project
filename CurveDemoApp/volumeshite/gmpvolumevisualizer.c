...
template <typename T, int n>
inline
void PVolumeVisualizer<T,n>::fillCubeVBO(GL::VertexBufferObject &vbo, T size)
{
...
template <typename T, int n>
inline
void PVolumeVisualizer<T,n>::fillCubeIBO(GL::IndexBufferObject &ibo, GLuint &no_indices)
{
...
template <typename T, int n>
inline
void PVolumeVisualizer<T,n>::fill3DTexture(const DVectorN< Vector<GLfloat,4>,n >&color, int m1, int m2, int m3, bool closed_u, bool closed_v, bool closed_w, GL::Texture& tex)
{
...
template <typename T, int n>
inline
void PVolumeVisualizer<T, n>::fillTransferFunction(GL::Texture &transfertex, const std::vector<Vector<float, 4> >& rgba, bool update )
{
...
template <typename T, int n>
inline
void PVolumeVisualizer<T,n>::replot(

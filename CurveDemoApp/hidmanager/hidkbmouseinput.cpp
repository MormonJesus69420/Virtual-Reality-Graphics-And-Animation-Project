...
void KeyModifierInput::setKeyboardModifiers(const Qt::KeyboardModifiers& keymods)
{
...
QString KeyModifierInput::toString() const
{
  ...
  if (keymods.testFlag(Qt::ShiftModifier))
    keymods_str += QString("Shift");
  if (keymods.testFlag(Qt::ControlModifier))
    keymods_str += QString("Ctrl");
  if (keymods.testFlag(Qt::AltModifier))
    keymods_str += QString("Alt");
  if (keymods.testFlag(Qt::MetaModifier))
    keymods_str += QString("Meta");
  if (keymods.testFlag(Qt::KeypadModifier))
    keymods_str += QString("Keypad");
  if (keymods.testFlag(Qt::GroupSwitchModifier))
    keymods_str += QString("GrpSw");
...
void KeyInput::setKeymap(const Keymap& keymap)
{
...
void MouseButtonInput::setMouseButtons(const Qt::MouseButtons& buttons)
{
...
QString MouseButtonInput::toString() const
{
  ...
  if (mouse_buttons.testFlag(Qt::LeftButton))
    mb_str_list += QString("Left");
  if (mouse_buttons.testFlag(Qt::RightButton))
    mb_str_list += QString("Right");
  if (mouse_buttons.testFlag(Qt::MiddleButton))
    mb_str_list += QString("Middle");
  if (mouse_buttons.testFlag(Qt::ExtraButton1))
    mb_str_list += QString("X1");
  if (mouse_buttons.testFlag(Qt::ExtraButton2))
    mb_str_list += QString("X2");
  if (mouse_buttons.testFlag(Qt::ExtraButton3))
    mb_str_list += QString("X3");
  if (mouse_buttons.testFlag(Qt::ExtraButton4))
    mb_str_list += QString("X4");
  if (mouse_buttons.testFlag(Qt::ExtraButton5))
    mb_str_list += QString("X5");
  if (mouse_buttons.testFlag(Qt::ExtraButton6))
    mb_str_list += QString("X6");
  if (mouse_buttons.testFlag(Qt::ExtraButton7))
    mb_str_list += QString("X7");
  if (mouse_buttons.testFlag(Qt::ExtraButton8))
    mb_str_list += QString("X8");
  if (mouse_buttons.testFlag(Qt::ExtraButton9))
    mb_str_list += QString("X9");
  if (mouse_buttons.testFlag(Qt::ExtraButton10))
    mb_str_list += QString("X10");
  if (mouse_buttons.testFlag(Qt::ExtraButton10))
    mb_str_list += QString("X11");
  if (mouse_buttons.testFlag(Qt::ExtraButton10))
    mb_str_list += QString("X12");
  if (mouse_buttons.testFlag(Qt::ExtraButton10))
    mb_str_list += QString("X13");
  if (mouse_buttons.testFlag(Qt::ExtraButton10))
    mb_str_list += QString("X14");
  if (mouse_buttons.testFlag(Qt::ExtraButton10))
    mb_str_list += QString("X15");
  if (mouse_buttons.testFlag(Qt::ExtraButton10))
    mb_str_list += QString("X16");
  if (mouse_buttons.testFlag(Qt::ExtraButton10))
    mb_str_list += QString("X17");
  if (mouse_buttons.testFlag(Qt::ExtraButton10))
    mb_str_list += QString("X18");
  if (mouse_buttons.testFlag(Qt::ExtraButton10))
    mb_str_list += QString("X19");
  if (mouse_buttons.testFlag(Qt::ExtraButton10))
    mb_str_list += QString("X20");
  if (mouse_buttons.testFlag(Qt::ExtraButton10))
    mb_str_list += QString("X21");
  if (mouse_buttons.testFlag(Qt::ExtraButton10))
    mb_str_list += QString("X22");
  if (mouse_buttons.testFlag(Qt::ExtraButton10))
    mb_str_list += QString("X23");
  if (mouse_buttons.testFlag(Qt::ExtraButton10))
    mb_str_list += QString("X24");
